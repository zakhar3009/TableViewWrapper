...
extension TableView {
    ...
    public class Coordinator: NSObject, UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate {
        ...
        let view: TableView
        /// A flag indicating whether a row has been deleted from the table view.
        ...
        public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            let cell = tableView.dequeueReusableCell(withIdentifier: Constans.cellReuseIdentifier, for: indexPath)
            if let tableViewCell = cell as? TableViewCell {
                ...
                tableViewCell.configure(with: content)
